...
__all__ = 'Path,np,pd,mpl,plt,sns,json,Iterable'.split(',') +\
...
from utils.general import mpl, plt, sns,json, Iterable
...
def tl_savefig(fig, fig_name, p_plot=None):
    if p_plot is None:
...
"""        
    ...
    def add_ax(self, x, y, width=1, height=1, rc={}, *args, **kwargs):
